...
import MovingGoods from 'components/warehouse/MovingGoods';
...
const Home = () => {
  ...
  return (
    ...
    <>
      <Head>
        <title>Moving Goods</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className="screen-background h-full">
        <div className="border-b-2 h-12">
          <div className="font-semibold text-lg font-play text-gradient text-left ml-12">
            MOVING GOODS
          </div>
        </div>
        <MovingGoods />

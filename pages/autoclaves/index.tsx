...
import Autoclaves from 'components/sterilization/Autoclaves';
...
const Index = () => {
  ...
  return (
    ...
    <>
      <Head>
        <title>Autoclaves</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className="screen-background">
        <div className="border-b-2 h-12">
          <div className="font-bold text-xl text-left ml-12 text-gradient">AUTOCLAVES</div>
        </div>
        <Autoclaves />
      </div>
    </>
